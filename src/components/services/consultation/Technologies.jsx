...
const Technologies = () => {
  const items = [
    { icon: "/assets/img/services/development/001-algorithm.png", title: "Cloud & infra" },
    { icon: "/assets/img/services/development/002-blog.png", title: "Backend & architecture" },
    { icon: "/assets/img/services/development/003-sitemap.png", title: "Frontend & mobile" },
    { icon: "/assets/img/services/development/004-layout.png", title: "Data & AI" },
    { icon: "/assets/img/services/development/005-data.png", title: "DevOps & reliability" },
    { icon: "/assets/img/services/development/006-browser.png", title: "Security & compliance" },
    { icon: "/assets/img/services/development/007-idea.png", title: "Delivery & collaboration" },
    { icon: "/assets/img/services/development/008-code.png", title: "Platform engineering and FinOps" },
  ];

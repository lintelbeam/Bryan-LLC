...
const Technologies = () => {
  const items = [
    { icon: "/assets/img/services/development/001-algorithm.png", title: "Containers and orchestration" },
    { icon: "/assets/img/services/development/002-blog.png", title: "Cloud and IaC" },
    { icon: "/assets/img/services/development/003-sitemap.png", title: "CI/CD and progressive delivery" },
    { icon: "/assets/img/services/development/004-layout.png", title: "Observability and SRE" },
  ];

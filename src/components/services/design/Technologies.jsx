...
const Technologies = () => {
  const items = [
    { icon: "/assets/img/services/design/001-wireframe.png", title: "User Journey Mapping" },
    { icon: "/assets/img/services/design/002-blueprint.png", title: "User Interface Design in Sketch" },
    { icon: "/assets/img/services/design/003-mockup.png", title: "Prototyping in Invisions" },
    { icon: "/assets/img/services/design/004-research.png", title: "User Research" },
  ];
